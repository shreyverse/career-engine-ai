...
export const OnboardingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050608] text-white py-6 px-4 sm:px-8 lg:px-12 relative overflow-hidden flex flex-col justify-between select-none">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[1400px] h-[500px] bg-gradient-to-b from-blue-600/10 via-purple-600/5 to-transparent blur-[160px] pointer-events-none rounded-full" />
      ...
      {/* Header: Edge-to-Edge across full width */}
      <header className="w-full flex items-center justify-between pb-4 border-b border-white/[0.08] relative z-10 px-2 sm:px-4">
        ...
        <Link to="/" className="flex items-center gap-2.5 group">
          ...
          <span className="font-display font-bold text-lg sm:text-xl text-white tracking-tight">Career Engine</span>
        </Link>

        {/* Right Side: Signed in user and Onboarding tag */}
      ...
      {/* Main Content Workspace: Wide & majestic */}
      <main className="w-full max-w-6xl lg:max-w-7xl mx-auto space-y-8 relative z-10 my-auto py-8 px-2 sm:px-4">
        ...
        {/* Dual Equal Career Stage Cards: Wide & Balanced */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 text-left w-full items-stretch">
          ...
          <div
            ...
            className={`p-7 sm:p-9 rounded-2xl border transition-all duration-200 cursor-pointer relative flex flex-col justify-between h-full ${
              selectedStage === "FRESHER"
                ? "bg-[#090E1A] border-blue-500 ring-2 ring-blue-500/40 shadow-[0_0_35px_rgba(59,130,246,0.25)]"
                : "bg-[#090E1A] border-white/[0.08] hover:border-blue-500/60 hover:bg-[#0C1322] hover:shadow-[0_0_25px_rgba(59,130,246,0.12)]"
          ...
          >
              ...
              <div className="pt-4 border-t border-white/[0.08] space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Student", "Recent Graduate", "Looking for First Job", "Self-Taught"].map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1.5 rounded-lg bg-[#111827] text-slate-300 border border-white/[0.06] text-xs font-medium"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            <div className="mt-8 pt-4 border-t border-white/[0.08] flex items-center justify-between text-xs sm:text-sm font-semibold text-blue-400">
          ...
          <div
            ...
            className={`p-7 sm:p-9 rounded-2xl border transition-all duration-200 cursor-pointer relative flex flex-col justify-between h-full ${
              selectedStage === "PROFESSIONAL"
                ? "bg-[#090E1A] border-violet-500 ring-2 ring-violet-500/40 shadow-[0_0_35px_rgba(139,92,246,0.25)]"
                : "bg-[#090E1A] border-white/[0.08] hover:border-violet-500/60 hover:bg-[#0C1322] hover:shadow-[0_0_25px_rgba(139,92,246,0.12)]"
          ...
          >
            ...
            <div className="mt-8 pt-4 border-t border-white/[0.08] flex items-center justify-between text-xs sm:text-sm font-semibold text-violet-400">
